...
Selected models are sliced with the default layer thickness and first-layer
offset configured in the application settings. The resulting sliced model can
