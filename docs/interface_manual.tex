...
to a bottom radius of 0.75 and a top radius of 0.5 model units.
...
model's layer polygons are expanded by a conservative envelope of the local
pillar radius and rasterized onto the configured cubic lattice. Starting with
