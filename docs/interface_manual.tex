...
separately for X, Y, and Z; their product must be at least the number of
selected models. The fill-order control lists the fastest-changing axis first,
so, for example, X then Y then Z fills an X row before advancing Y and finally
Z. Unused cells at the end of the lattice are permitted. The center of the
first selected model remains fixed at the first cell.
