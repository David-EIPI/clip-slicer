...
subsequent layer, support propagates only from supported material in the
previous layer, within the distance allowed by the critical angle. This marks
both disconnected new contours and overhanging edges. Transforming a model
clears the overlay because the previous result no longer represents its
current position.
